...
$searchString ='109-enfant';
    $this -> dst = 'images/profil/'.$upload_dir.'/pending-parent-solo-enfant-'.$but_hid.'.jpg';
   // $this -> dst = 'images1/' . date('YmdHis') . '.png';
  }
...
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-35-enfant-'.$but_hid.'.jpg', $data, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-89-enfant-'.$but_hid.'.jpg', $data2, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-109-enfant-'.$but_hid.'.jpg', $data3, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-220-enfant-'.$but_hid.'.jpg', $data4, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-enfant-'.$but_hid.'.jpg', $data5, false, $context);
