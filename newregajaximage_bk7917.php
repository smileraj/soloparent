...
//end resize
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-35-profil-'.$maxvalue.'.jpg', $data, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-89-profil-'.$maxvalue.'.jpg', $data2, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-109-profil-'.$maxvalue.'.jpg', $data3, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-220-profil-'.$maxvalue.'.jpg', $data4, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-profil-'.$maxvalue.'.jpg', $data5, false, $context);
echo ("images/profil/$upload_dir/temp-solo-220-profil-$maxvalue.jpg");
}
