...
$_SESSION['acc_saved_alias']=$userProfil->acc_saved_alias;
		...
		$post = array('FILE' => $cFile,'FILE_REFERENCE' => 'File3599','PSPID' => 'parentsoloTEST','USERID' => 'parentsoloUSERID','PSWD' => 'Parentsolo2017!','TRANSACTION_CODE' => 'ATR','OPERATION' => 'SAL','NB_PAYMENTS' => '1','REPLY_TYPE' => 'XML','MODE' => 'SYNC','PROCESS_MODE' => 'SEND');
			$ch = curl_init();
...
if($fileId!=''){
	$query = "INSERT INTO batch_send_file SET"
			...
			if($row->batch_id!='1' && $fileId!=''){
					$urlVal= 'https://e-payment.postfinance.ch/ncol/test/AFU_agree.asp';	
					$post1 = array('PSPID' => 'parentsoloTEST','USERID' => 'parentsoloUSERID','PSWD' => 'Parentsolo2017!','REPLY_TYPE' =>'XML','MODE' =>'SYNC','PFID'=>$fileId,'PROCESS_MODE' =>'PROCESS');
