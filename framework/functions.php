<?php
	...
	class FCT {
		...
		public static function &getSearchEngine($search_nb_enfants = 0, $search_recherche_age_min = 18, $search_recherche_age_max = 70, $search_canton_id = 0, $search_ville_id = 0, $search_username = '', $search_online = 0, $search_titre = '') {
