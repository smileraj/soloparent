...
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-109-enfant-'.$child_img.'.jpg', $data3, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-220-enfant-'.$child_img.'.jpg', $data4, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-parent-solo-enfant-'.$child_img.'.jpg', $data5, false, $context);
echo ("images/profil/$upload_dir/temp-parent-solo-220-enfant-$child_img.jpg");
}
