		...
		public static function lister(&$contenus, &$search, &$lists) {
			...
			?>
				...
				<div class="titlebar app_redac">
					<div class="toolbar">
						<a href="<? echo SITE_URL_ADMIN; ?>/index.php?app=expert&action=edit" title="R&eacute;diger une nouvelle annonce d'expert">R&eacute;diger</a>
			...
			<form name="editForm" action="<? echo SITE_URL_ADMIN; ?>/index.php" method="post">
				...
				<div class="titlebar app_redac">
					<div class="toolbar">
						...
						<a href="<? echo SITE_URL_ADMIN; ?>/index.php?app=expert" title="Annuler" class="cancel">Annuler</a>
						<a href="<? echo SITE_URL_ADMIN; ?>/index.php?app=expert" title="Fermer" class="cancel">Fermer</a>
					</div>
