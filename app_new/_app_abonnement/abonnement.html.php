		...
		<div class="content">
			<div class="contentl">
				...
				<? // BVR
					...
					<br />
					<br />
					<img src="<? echo SITE_URL; ?>/<? echo $imageBVR; ?>?<? echo time(); ?>" alt="BVR ParentSolo.ch CHF <? echo $montant; ?>.-" style="width:630px" />
				<? 
					} 
				?>
				</div>
	...
	function abonnementTarifs(&$contenu, &$debut) {
		...
		<div class="content">
			...
			<table class="abonnement" width="100%">
				<tbody>
					...
					<tr class="abonnement_blanc">
						...
						<td align="center"><img alt="" src="http://www.parentsolo.ch/~dev/images/non.gif" /></td>
						<td align="center"><img alt="" src="http://www.parentsolo.ch/~dev/images/oui.gif" /></td>
						<td align="center"><img alt="" src="http://www.parentsolo.ch/~dev/images/oui.gif" /></td>
					</tr>
					<tr>
			...
			<form name="abonnementForm" action="index.php?<?php echo$langue;?>" method="post">
				<center>
					...
					<div class="tarifs">
						<a href="javascript:offre(4);">
							<img src="<? echo SITE_URL; ?>/images/offreOn.gif" alt="" id="abo4" />
						...
						<a href="javascript:offre(3);">
							<img src="<? echo SITE_URL; ?>/images/offreOn.gif" alt="" id="abo3" />
				...
				<br />
				<a href="javascript:abonnementFormSubmit(1);" class="methode m1" title="<?php echo $lang_appabonnement["PaiementEnLigne"];?>"><img src="<? echo SITE_URL; ?>/images/methode1-<? echo $_GET['lang']?>.png" alt="<?php echo $lang_appabonnement["PaiementEnLigne"];?>" /></a>
				<a href="javascript:abonnementFormSubmit(2);" class="methode m2" title="<?php echo $lang_appabonnement["VirementBancaire"];?>"><img src="<? echo SITE_URL; ?>/images/methode2-<? echo $_GET['lang']?>.png" alt="<?php echo $lang_appabonnement["VirementBancaire"];?>" /></a>
				<a href="javascript:abonnementFormSubmit(3);" class="methode m3" title="<?php echo $lang_appabonnement["BulletinVersement"];?>"><img src="<? echo SITE_URL; ?>/images/methode3-<? echo $_GET['lang']?>.png" alt="<?php echo $lang_appabonnement["BulletinVersement"];?>" /></a>
				<br />
				<br />				
				<h2><?php echo $debut->titre;?></h2>
				<br />
			...
			<div class="contentl">
				<div class="colc">
					<form name="formPaypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
						...
						<input type="hidden" name="lc" value="<? echo $_GET['lang']; ?>">
						<input type="hidden" name="business" value="BRS9LKSKQ72EQ">
						<input type="hidden" name="item_name" value="<? echo htmlentities($row->nom); ?> (ref <? echo $row->paypal_id; ?>)">
						<input type="hidden" name="item_number" value="1">
						<input type="hidden" name="amount" value="<? echo $row->prix; ?>">
						<input type="hidden" name="currency_code" value="CHF">
						<input type="hidden" name="no_note" value="1">
						<input type="hidden" name="no_shipping" value="1">
						<input type="hidden" name="return" value="<? echo SITE_URL; ?>/index.php?app=abonnement&action=methode&<? echo $langue; ?>">
						<input type="hidden" name="cancel_return" value="<? echo SITE_URL; ?>/index.php?app=abonnement&action=methode&custom=0&<? echo $langue; ?>">
						<input type="hidden" name="notify_url" value="<? echo SITE_URL; ?>/paypal.php">
						<input type="hidden" name="custom" value="<? echo $row->custom; ?>">
					</form>
					<script language="javascript" type="text/javascript">
					...
					<div style="text-align:center;padding:20px; border:solid 1px #3b3f40">
						<img src="<? echo SITE_URL; ?>/images/paypal-logo.jpg" alt="Paypal" /><br />
						<br />
						<?php echo $lang_appabonnement["RedirectionPaypal"];?>.<br />
						<br />
						<img src="<? echo SITE_URL; ?>/images/paypal-loading.gif" alt="Chargement..." /><br />
						<br />
