...
?>
   ...
   <div class="price_cls">
            ...
            <p class="parentsolo_pb_10 parentsolo_pt_10 font_size_16"><i><?php echo $lang_appabonnement["Duree360"];?></i></p>
				...
				<table class="abonnements_table avantages" cellpadding="0" cellspacing="0" width="100%">
					<tbody>
						<tr>
							<th width="50%">&nbsp;</td>
							<th align="center"><?php echo $lang_appabonnement["Visiteur"];?></td>
							<th align="center"><?php echo $lang_appabonnement["Membre"];?></td>
							<th align="center"><?php echo $lang_appabonnement["Abonne"];?></td>
						</tr>
						<tr>
							<td><?php echo $lang_appabonnement["EffectuerDesRecherches"];?></td>
							<td align="center"><img alt="" src="http://www.parentsolo.swiss/images/non.gif" /></td>
							<td align="center"><img alt="" src="http://www.parentsolo.swiss/images/oui.gif" /></td>
							<td align="center"><img alt="" src="http://www.parentsolo.swiss/images/oui.gif" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class='fin' <?php /* if($_GET['lang']!='fr'){ echo "class='fin'";} */ ?> align="center"><img alt="" src="http://www.parentsolo.swiss/images/non.gif" /></td>
							<td class='fin' <?php /* if($_GET['lang']!='fr'){ echo "class='fin'";} */ ?> align="center"><img alt="" src="http://www.parentsolo.swiss/images/non.gif" /></td>
							<td class='fin' <?php /* if($_GET['lang']!='fr'){ echo "class='fin'";} */ ?> align="center"><img alt="" src="http://www.parentsolo.swiss/images/oui.gif" /></td>
						</tr>
						<?php
							/*if($_GET['lang']=='fr'){
						?>
							<tr>
								...
								<td class='fin' align="center"><img alt="" src="http://www.parentsolo.swiss/images/non.gif" /></td>
								<td class='fin' align="center"><img alt="" src="http://www.parentsolo.swiss/images/non.gif" /></td>
								<td class='fin' align="center"><img alt="" src="http://www.parentsolo.swiss/images/oui.gif" /></td>
							</tr>
						<?php
							}*/
						?>
	...
	function abonnementServiceIndisponible() {
		global $langue, $user;
		include("lang/app_abonnement.".$_GET['lang'].".php");
	...
	// formulaire paypal
	function postfinanceForm(&$row,&$row1) {
			include("lang/app_abonnement.".$_GET['lang'].".php");
		global $langue;
		global $user;
...
$ogone_ACCEPTURL = 'http://www.parentsolo.swiss/index.php?app=abonnement&action=details&lang='.$_GET['lang'].'&result=Success';
$ogone_CANCELURL = 'http://www.parentsolo.swiss/index.php?app=abonnement&action=details&lang='.$_GET['lang'].'&result=canceled';
$ogone_DECLINEURL = 'http://www.parentsolo.swiss/index.php?app=abonnement&action=details&lang='.$_GET['lang'].'&result=decline';
$ogone_EXCEPTIONURL = 'http://www.parentsolo.swiss/index.php?app=abonnement&action=details&lang='.$_GET['lang'].'&result=exception';
$ogone_ACCEPTURL_alias = 'http://www.parentsolo.swiss/index.php?app=abonnement&action=SavedCarddetails&lang='.$_GET['lang'].'&result=Success';
$ogone_EXCEPTIONURL_alias = 'http://www.parentsolo.swiss/index.php?app=abonnement&action=SavedCarddetails&lang='.$_GET['lang'].'&result=exception';


$ogone_AMOUNT1 =$row1->montant; 
...
<form method="post" action="ajax_paymnetRedirection.php"><!--ajax_savedcard.php-->
      ...
      <!--  <input type="hidden" name="OWNERZIP" value="<?php echo $ogone_OWNERZIP;?>">
		...
		<input type="hidden" name="Amount_valenc" value="<?php echo base64_encode($row1->montant);?>"> 
...
function onclick_show_card(){	
  ...
  //alert('hai');
   ...
   document.getElementById('BRAND_val').required = false;
	...
	function SavedCarddetails(&$Saved_OrderID,&$Saved_CN,&$Saved_NCErrorCN,&$Saved_CardNo,&$Saved_Brand,&$Saved_NCErrorCardNo,&$Saved_CVC,&$Saved_NCErrorCVC,&$Saved_ED,&$Saved_NCErrorED,&$Saved_NCError,&$Saved_Alias,&$Saved_status,&$Saved_SHASign,&$row){
	global $langue;
	include("lang/app_abonnement.".$_GET['lang'].".php");
	if($Saved_Alias !=''){
...
<form method="post" action="https://secure.ogone.com/ncol/test/orderstandard_utf8.asp" id=form3 name=form3>
        <input type="hidden" name="PSPID"       value="<?php echo $ogone_PSPID;?>">
      ...
      <!--  <input type="hidden" name="OWNERZIP" value="<?php echo $ogone_OWNERZIP;?>"> 
        ...
        <!-- v�rification avant le paiement : voir S�curit� : v�rification avant le paiement (facultatif) -->
        ...
        <!-- redirection apr�s la transaction : voir Feedback au client sur la transaction -->
        <input type="hidden" name="ACCEPTURL" value="<?php echo $ogone_ACCEPTURL;?>">
        <input type="hidden" name="DECLINEURL" value="<?php echo $ogone_DECLINEURL;?>">
        <input type="hidden" name="EXCEPTIONURL" value="<?php echo $ogone_EXCEPTIONURL;?>">
        <input type="hidden" name="CANCELURL" value="<?php echo $ogone_CANCELURL;?>">
