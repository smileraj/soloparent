<?php
	...
	/*
		...
		save: submit le formulaire de nouvel appel � t�moins
		list: lister les appels � t�moins
		read: lire un appel � t�moins complet
	*/
	switch($action) {
	...
	function appel_a_temoinsWrite($messages) {
		...
		$list_media_id[] = JL::makeOption('0', '> Types de m�dias');
	...
	function appel_a_temoinsSave() {
		...
		*/
		...
		if(!count($messages)) {
			...
			// enregistre le logo s'il a �t� envoy�
			if($ext != '' && $ext != 'error') {
