	...
	<div class="row">
				<div class="col-md-10 col-md-offset-1 parentsolo_form_style">
					...
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<input type="text" id="date_limite" required class="msgtxt" name="date_limite" maxlength="50" value="<?php echo $row->date_limite; ?>">
						</div>
					</div>
					</div>
					<div class="row bottompadding">
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<input type="text" id="date_diffusion" required class="msgtxt" name="date_diffusion" maxlength="50" value="<?php echo $row->date_diffusion; ?>">
						</div>
					</div>
					</div>
					<div class="row bottompadding">
					...
					<div class="row bottompadding">
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<input type="text" required id="nom" class="msgtxt" name="nom" maxlength="50" value="<?php echo $row->nom; ?>">
							</div>
						</div>
					</div>
					<div class="row bottompadding">
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<input type="text" required id="prenom" class="msgtxt" name="prenom" maxlength="50" value="<?php echo $row->prenom; ?>">
							</div>
						</div>
					</div>
					<div class="row bottompadding">
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<input type="text" required id="telephone" class="msgtxt" name="telephone" maxlength="50" value="<?php echo $row->telephone; ?>">
							</div>
						</div>
					</div>
					<div class="row bottompadding">
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<textarea name="adresse" required style="width:100%; height: 105px;"><?php echo $row->adresse; ?></textarea>
							</div>
						</div>
					</div>
					<div class="row bottompadding">
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<input type="text" required id="email" class="msgtxt" name="email" maxlength="50" value="<?php echo $row->email; ?>">
							</div>
						</div>
					</div>
					<div class="row bottompadding">
						<div class="col-md-12">
							...
							<div class="col-md-8">
								<input type="text" required id="email2" class="msgtxt" name="email2" maxlength="50" value="<?php echo $row->email2; ?>">
							</div>
						</div>
					</div>
					<div class="row bottompadding">
					...
					<div class="row bottompadding">
						...
						?>
							...
							<div class="col-md-6">
								: <input type="text" required name="codesecurite" id="codesecurite" value="" maxlength="2" style="width:100px;"/>
							</div>
						</div>
					</div>
					<div class="row bottompadding">
