		...
		function panel(&$profilsOnline, &$profilsInscrits, $genreRecherche, &$list, &$appel_a_temoins, &$temoignage) {
			...
			<div class="app_body">
				...
				<div class="panel_left">
					...
					<h2><?php echo $genreRecherche == 'h' ? $lang_appprofil["LESDERNIERS"] : $lang_appprofil["LESDERNIERES"]; ?> <?php echo $genreRecherche == 'h' ? $lang_appprofil["PAPAS_S"] : $lang_appprofil["MAMANS_S"]; ?> <?php echo $genreRecherche == 'h' ? $lang_appprofil["INSCRITS"] : $lang_appprofil["INSCRITES"]; ?></h2>
					<div class="preview4">
...
<!--<a href="http://www.dynapresse.ch" target="_blank">
							<img src="<?php echo SITE_URL; ?>/parentsolo/images/dynapresse.jpg">
						</a> -->
					</div>

					<br />
					<a href="http://www.babybook.ch" target="_blank" title="Babybook, le m�dia familial Suisse Romand de 0 � 8 ans"><img src="<?php echo SITE_URL; ?>/images/banners/banner-250x250-v2.jpg" alt="Babybook, le m�dia familial Suisse Romand de 0 � 8 ans" /></a> 

					<?php 						// s'il y a un appel � t�moins � afficher
						if($appel_a_temoins) {
						?>
						...
						// s'il y a un t�moignage � afficher
						if($temoignage) {
						...
						<div class="bloc_center">
							...
							<p>
								<a href="<?php echo JL::url('index.php?app=temoignage&action=read&id='.$temoignage->id.'&'.$langue); ?>" title="<?php echo $lang_appprofil["LireTeoignageDe"];?> <?php echo $temoignage->username; ?>"><img src="<?php echo $photo; ?>" alt="<?php echo $temoignage->username; ?>" /></a><?php echo $temoignage->texte; ?>
							</p>
		...
		function profil(&$profil, &$profilEnfants, &$profilDescription, &$profilInfosEnVrac1, &$profilInfosEnVrac2, &$profilQuotidien1, &$profilQuotidien2, &$profilQuotidien3, &$profilQuotidien4, &$profilGroupes) {
			...
			<div class="app_body">
				...
				if($profil->accessok) {
					...
					// variables par d�faut (plus de 2 semaines)
