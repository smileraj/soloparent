...
$result1 = mysql_query ($query);
 if($result1!=mysql_query){
	...
	class head_HTML {
		...
		function head($userProfilMini,$userStats,$userpercentage,$perannounce,$userStats,$useronstatus) {
			...
			if($_GET['lang']=='fr'){
				...
				$navString = "  
                <li><a href='".$_SERVER['PHP_SELF']."?lang=de".$navString."'>Deutsch <img style='width: 16px; border: inherit; ' src='".SITE_URL."/images/icons/de.png'> </a></li>
                <li><a href='".$_SERVER['PHP_SELF']."?lang=en".$navString."'>English <img style='width: 16px; border: inherit; ' src='".SITE_URL."/images/icons/en.png'></a></li> ";
			}
            elseif($_GET['lang']=='en'){
				$nav_active_string= "English <img style='width: 16px; border: inherit; ' src='".SITE_URL."/images/icons/en.png'>";
			    $navString = "<li><a href='".$_SERVER['PHP_SELF']."?lang=fr".$navString."'>Fran&ccedil;ais <img style='width: 16px; border: inherit; ' src='".SITE_URL."/images/icons/fr.png'> </a></li>
                <li><a href='".$_SERVER['PHP_SELF']."?lang=de".$navString."'>Deutsch <img style='width: 16px; border: inherit; ' src='".SITE_URL."/images/icons/de.png'></a> </li>
