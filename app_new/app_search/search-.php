<?php
	...
	// si non log dans l'appli search (hors step8submit qui fait partie du processus compliqu� d'inscription)
	...
	switch($action) {
		...
		case 'results':
			...
			// on n'affiche pas le formulaire de recherche pour le lien "En ligne", d'o� le test du GET uniquement (en POST on vient du formulaire de recherche)
