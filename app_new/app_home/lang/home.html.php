	...
	class home_HTML {		
		...
		?>
            ...
            <section class="rd-parallax">
               <div data-speed="0.4" data-type="media" data-url="parentsolo/images/home-01.jpg" class="rd-parallax-layer"></div>
               ...
               <div data-speed="0" data-type="html" class="rd-parallax-layer">
				...
				<!-- Join its free Section Start -->
					...
					<!--<h3><?php echo $lang_apphome["InscriptionGratuite"];?></h3> -->
					    <form action="<?php echo JL::url('index.php?app=profil&action=inscription').'&lang='.$_GET['lang'];?>" name="inscriptionMini" method="post" class="custom form-search">
    			...
    			<div id="radios1">
    				...
    				<label for="option7" class="inscription_icon"><span><?php echo $lang_apphome["gendre_lan_f"];?>&nbsp;<i class="fa fa-female"></i></span></label>
						...
						<div class="row bottompadding">
							...
							<div class="col-md-8">								
							<div class="col-md-3 col-sm-3 padding_left_0 padding_right_5 col-sm-width"><?php echo $list['naissance_jour']; ?></div>
							<div class="col-md-3 col-sm-3 padding_left_0 padding_right_5 col-sm-width"><?php echo $list['naissance_mois']; ?></div>
							<div class="col-md-6 col-sm-6  padding_left_0 padding_right_0 col-sm-width"><?php echo $list['naissance_annee']; ?></div>	
...
<input id="option4" name="nb_enfants" type="radio"  value="4">
    				...
    				<label for="option5">+&nbsp;than&nbsp;5</label>
				...
				<script type="text/javascript">
					...
					<!--<div class="row"><div class="col-md-12"><?php echo $lang_apphome["UnGage..."];?></div></div>-->
					</div>
			...
			<section class="skew-1 section-bottom-0 section-top-80 section-md-top-0 backrgound">
				
				
				<div class="shell offset-md-top-66">
				<div class="img-baner"><!--<img src="parentsolo/images/home-02.png" alt="">--></div>
				<div class="row row-no-gutter position-r positiontop">
				<div class="col-sm-6 col-md-6">
				<div class="block-2 con section-lg-top-140 inset-md-left-15">
				
				<div class="col-md-12">
				<div class="baner text-left">
				<h1 class="position-r font_size_sm"><?php echo $lang_apphome["PourquoiChoisirParentsolo"];?>?</h1>
				...
				<h4 class="parentsolo_title_h3"  style="color:#bf181a !important;"><?php echo $lang_apphome["Mamans"];?></h4>
					<h4 class="parentsolo_title_h3 " style="color:#bf181a !important;"><?php echo $lang_apphome["Papas"];?></h4>
					</div>
				...
				<section class="skew-2 section-md-top-10 section-md-bottom-355 section-top-60 section-bottom-110">
				<div class="text-left position-r">
				<h1 class="text-white text-center headerskin  parentsolo_mb_40" style="padding-bottom:20px; font-size:32px;"><?php echo $lang_apphome["NewMembers"];?></h1>
...
<div class="range offset-top-16 tab_div_stl">
	...
	<div class="col-lg-4 col-md-4 col-sm-6 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 col-xs-offset-2 col-xs-8 wd_card">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-lg-offset-0 col-md-offset-0 col-sm-offset-0 col-xs-offset-2 col-xs-8 wd_card">
                            <div class="wd_event_section text-center">
                                ...
                                <div class="wd_item wd_square effect9 bottom_to_top">
                                    <a href="#">
                                        <div class="img">
											<a href="<?php echo $home_3->url; ?>" title="<?php echo $home_3->titre;?>" >
											<img  src="<?php echo $template; ?>/images/box/<?php echo $home_3->id; ?>-<?php echo $_GET['lang']; ?>.jpg" title="<?php echo $home_3->titre;?>"/>
											</a>
                                        </div>
                                        <div class="wd_event_info">
                                            <div class="wd_event_info_back">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-lg-offset-0 col-md-offset-0 col-sm-offset-3 col-xs-offset-2 col-xs-8 wd_card">
                            <div class="wd_event_section text-center">
                                <div class="wd_item wd_square effect9 bottom_to_top">
                                    <a href="#">
                                        <div class="img">
											<a href="<?php echo $home_4->url; ?>" title="<?php echo $home_4->titre;?>" ><img  src="<?php echo $template; ?>/images/box/<?php echo $home_4->id; ?>-<?php echo $_GET['lang']; ?>.jpg" title="<?php echo $home_4->titre;?>"/>
											</a>
                                        </div>
                                        <div class="wd_event_info">
                                            <div class="wd_event_info_back">
...
</section><section class="skew-3 section-md-top-10 section-md-bottom-315 section-top-80 section-bottom-77">
			...
			<div class="col-md-6 offset-md-top-13 ">
					<h2 class="text-white text-center headerskin" style="padding-top:20px;">
				...
				<?php
								...
								$photo1 = JL::userGetPhoto($events->uservalue, '220', 'profil', $temoignage->photo_defaut);
					...
					?>
				<div class="range offset-top-60 profiles position-r" style="text-align: center;">
					<div class="cell-md-2  cell-sm-12"><img class="image_bg_sty" src="<?php echo $photo; ?>" alt="<?php echo $temoignage->username; ?>" />
				</div>
				<div class="cell-md-10  cell-sm-12 font_clr"><h4 class="text-white letter-spacing offset-top-10 padding-bottom-10"><?php echo $temoignage->titre; ?></h4>
				...
				<div class="col-md-6 offset-md-top-13 ">
				<h2 class="text-white text-center headerskin" style="padding-top:20px;"><?php echo $lang_apphome["Events_lan"];?></h2>
				<div class="range  profiles position-r" style="text-align: center;">
					<!--<div class="cell-md-2  cell-sm-12"><img class="image_bg_sty" src="<?php echo $photo1; ?>" alt="<?php echo $events->username; ?>" />
				</div>-->
				<div class="cell-md-12  cell-sm-12 font_clr"><h4 class="text-white letter-spacing offset-top-10 padding-bottom-10"><?php echo $events->event_name; ?></h4>
					<p style="font-size:15px;" class="height_p"><?php echo $events->event_desc; ?><br>
					</p>
			...
			<div class="text-left position-r" style=" width:1px;">
			
				<div class="shell offset-md-top-13 " style=" width:1px;">&nbsp;
				<!--<div class="range  profiles position-r" style="text-align: center;">
					<div class="cell-md-2  cell-sm-12"><img class="image_bg_sty" src="<?php echo $photo1; ?>" alt="<?php echo $events->username; ?>" />
				</div>
				<div class="cell-md-12  cell-sm-12 font_clr"><h4 class="text-white letter-spacing offset-top-10 padding-bottom-10"><?php echo $events->event_name; ?></h4>
					<?php echo $events->event_desc; ?><br>
					<span class="username text-right" ><h6 class="offset-top-10"><?php echo $events->username; ?></h6></span>
					</div>-->
					</div>
				</div>
...
<section class="skew-1-1 section-lg-bottom-130 position-r-1 section-top-80 section-md-top-0 section-bottom-90">
...
<div class="range offset-top-16 tab_div_stl">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-0 col-md-offset-0 col-sm-offset-1 col-xs-offset-2 col-xs-8 wd_card">
