<?php
	...
	switch($action) {
		...
		case 'baremeedit':
			...
			} else { // si pas d'id, on retourne � la liste
	...
	// sauvegarde les donn�es dans la DB
	function baremeSave() {
		global $db, $messages;
	...
	// affiche le classement d'un mois donn�
	function classementList() {
		...
		// liste d�roulante des ann�es-mois
		...
		// correction du param�tre annee_mois si celui-ci n'est pas d�fini
		...
		// r�cup le classement de l'$annee_mois
