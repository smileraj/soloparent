			...
			<section class="panel">
				...
				<div class="tableAdmin">
					...
					<table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed cf editer">
						...
						<tr>
							<td class="key"><label for="nom_fr">Nom <img width="20px;" src="http://www.parentsolo.ch/newdev/parentsolo/images/grph_flags_fr_h20.jpg" alt="fr">:</label></td>
						...
						<tr>
							<td class="key"><label for="nom_en">Nom <img width="20px;" src="http://www.parentsolo.ch/newdev/parentsolo/images/grph_flags_en_h20.jpg" alt="en">:</label></td>
						...
						<tr>
							<td class="key"><label for="nom_de">Nom <img width="20px;" src="http://www.parentsolo.ch/newdev/parentsolo/images/grph_flags_de_h20.jpg" alt="de">:</label></td>
