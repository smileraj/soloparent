...
?>
		...
		<div class="col-md-6 col-sm-12">
				<div class="form-group row" style="padding-top:40px;" >
                 <label  class="col-sm-4" name="lbl_evt_name">Title<span>*</span></label>
				<div class="col-sm-8">
...
<div class="form-group row">
				<label class="col-sm-4" name="lbl_evt_desc">Description<span>*</span></label>
				<div class="col-sm-8">
...
<div class="form-group row">
				<label class="col-sm-4" name="lbl_evt_sdate">Start Date<span>*</span></label>
				<div class="col-sm-8">
...
<div class="form-group row">
				<label class="col-sm-4" name="lbl_evt_edate">End Date<span>*</span></label>
				<div class="col-sm-8">
				<input type="text" name="txt_evt_edate" required  class="form-control datepicker validation updateval" id="txt_evt_edate">
				</div>
</div>
<div class="form-group row">
				<label class="col-sm-4" name="lbl_evt_logo">Logo<span>*</span></label>
				<div class="col-sm-8">
			...
			<input type="hidden" name="rowid"  class="validation updateval" id="rowid">
				...
				<p><small>(GIF, JPG and PNG only)</small></p>
				</div>
				
</div>
</div><div class="col-md-3 col-sm-12" style="padding-top:40px;">
<img  id="event_img" src="#" style="width:100%;    border: 5px solid #ccc;    border-radius: 5px;">	
					</div>
...
$('#txt_evt_logo').removeAttr('required');
