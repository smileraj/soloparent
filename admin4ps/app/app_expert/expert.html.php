		...
		public static function lister(&$contenus, &$search, &$lists) {
			...
			function cancelsubmit(action) {
				...
				<div class="row">
                  <div class="col-lg-12">				
					<div class="toolbar">
						<a href="<?php echo SITE_URL_ADMIN; ?>/index.php?app=expert&action=edit" title="R&eacute;diger une nouvelle annonce d'expert" class="btn btn-success">R&eacute;diger</a>
				...
				<div class="tableAdmin">
					<div class="filtre">
						<table class="table table-bordered table-striped ">
							<tr>
								<td><b>Recherche:</b></td>
								<td colspan="3"><input type="text" name="search_at_word" id="search_at_word" value="<?php echo makeSafe($search['word']); ?>" class="searchInput" /></td>
							</tr>
							<td><b>Tri par:</b></td>
		...
		public static function editer(&$contenu, &$lists, &$messages) {
			...
			function cancelsubmit(action) {
						...
						if(ok) {
							...
							document.location = "<?php echo SITE_URL_ADMIN; ?>/index.php?app=expert"; 
						}
