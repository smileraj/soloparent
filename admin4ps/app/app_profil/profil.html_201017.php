						...
						?>
							<tr class="list<?php if($jours > 0 && $jours <= 3) { ?> jours3<?php } ?><?php if($warning) { ?> warning<?php } ?>" >
								...
								*/ ?>
								...
								<td align="center"><img src="images/<?php echo $user->user_status_code; ?>.png" alt="<?php echo $user->user_status_code ? 'Oui' : 'Non'; ?>" /></td>
									...
									<?php 											foreach($photos as $photo) {
											?>
												<div class="col-md-1 col-sm-2 col-xs-3"><div class="profilPhoto">
													<img src="<?php echo SITE_URL; ?>/images/profil/<?php echo $user->id; ?>/<?php echo $photo; ?>" alt="" width='100%'/>
												</div></div>
											<?php 											}
										?>
								</td>
