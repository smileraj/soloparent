<?php
	...
	define('SITE_URL', 					'http://www.parentsolo.ch/newdev');
	define('SITE_URL_ADMIN', 			'http://www.parentsolo.ch/newdev/admin4ps');
	define('SITE_URL_ADMIN_EXPERT', 	'http://www.parentsolo.ch/newdev/admin4expertps');
