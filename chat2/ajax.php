		...
		?>
		 ...
		 <div class="top chatboxhead">
			<div class="col-md-6 col-sm-6 col-xs-6  parentsolo_plr_0"> <div class="col-md-3  col-sm-3 col-xs-3  parentsolo_plr_0 parentsolo_mt_20">  <span style="">
                     <a class="userimage chatProfileToImg " onClick="return targetopener(this,true)"   href="<? echo SITE_URL; ?>/index.php?app=profil&action=view&id=<? echo $correspondant->id.$langue; ?>'">
...
> <span  class="name nickname<? echo $correspondant->genre; ?>"><? echo $correspondant->username; ?></span><br>
					<span class='online_<? echo $correspondant->online; ?> display_none'><? echo $online_2; ?></span>
                </span></div></div>
               <div class="col-md-6  col-sm-6 col-xs-6"><div class='chatProfileToTxt  text-right'>
					...
					<span class="project"><? echo $correspondant->canton; ?></span>
	...
	function getConversation($id_corresp){
		...
		?>
		<br>
			<a  onClick="return targetopener(this,true)"   href="<? echo SITE_URL; ?>/index.php?app=abonnement&action=tarifs<? echo $langue; ?>" > [ <? echo  $langChat["Abonnement"]; ?> ] </a>
		<?
