<?php
	...
	// &agrave; placer toujours apr�s les 2 limitations
	...
	<div class="col-md-12 col-sm-12  testimonials-style-2 testimonials-bg_admin parentsolo_pl-r">
                ...
                <div class="box">
                    <div class="outer">
                        <div class="round">
                                ...
                                <img width="100" height="100" src="<?php echo SITE_URL.'/'.$image; ?>" alt="<?php echo $groupe->titre; ?>"   class="attachment-70x70 size-70x70 wp-post-image" alt="26" srcset="<?php echo SITE_URL.'/'.$image; ?>" sizes="(max-width: 70px) 100vw, 70px">
            ...
            <div class="col-md-9 col-sm-8 col-sx-8">
                <div class="parentsolo_pt_15 parentsolo_pl_15">
                    <h3 class="name parentsolo_pt_10"><?php echo $groupe->titre; ?></h3>
                    <div class="text-box parentsolo_pt_10 parentsolo_pb_10">
						<?php echo $groupe->texte; ?>
						</div>
				
						<h6 class="parentsolo_text-right parentsolo_txt_clr parentsolo_txt_overflow">
							<a href="<?php echo JL::url('index.php?app=groupe&action=list&groupe_type=all'.'&'.$langue); ?>" title="<?php echo $lang_mod["TousLesGroupes"];?>" class="plus"><?php echo $lang_mod["TousLesGroupes"];?></a>
						</h6>
