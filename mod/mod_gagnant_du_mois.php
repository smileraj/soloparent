 	...
 	<div class="col-md-12 col-sm-12  testimonials-style-2  testimonials-bg_admin parentsolo_pl-r">
            <div class="col-md-3 col-sm-4 col-sx-4 parentsolo_pl_0 Parentsolo_imgbg_color">
                <div class="box">
                    <div class="outer">
                        <div class="round">
                            <a href="<? echo JL::url('index.php?app=profil&action=view&id='.$gagnant->user_id.'&lang='.$_GET['lang']); ?>" target="_blank"  title="<? echo $lang_mod["VoirCeProfil"]; ?>">
            ...
            <div class="col-md-9 col-sm-8 col-sx-8">
                <div class="parentsolo_pt_15 parentsolo_pl_15 ">
                    <h2 class="name parentsolo_pt_10"><a href="<? echo JL::url('index.php?app=profil&action=view&id='.$gagnant->user_id.'&lang='.$_GET['lang']); ?>" target="_blank"  title="<? echo $lang_mod["VoirCeProfil"];?>" class="username"><? echo $gagnant->username; ?></a></h2>
