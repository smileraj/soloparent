...
//end resize
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-35-enfant-'.$child_img.'.jpg', $data, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-89-enfant-'.$child_img.'.jpg', $data2, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-109-enfant-'.$child_img.'.jpg', $data3, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-220-enfant-'.$child_img.'.jpg', $data4, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/temp-solo-enfant-'.$child_img.'.jpg', $data5, false, $context);
echo ("images/profil/$upload_dir/temp-solo-220-enfant-$child_img.jpg");
}
