<?php
	...
	// anti cache
	$version = 'v60';
$template_url="https://esales.in/parentsolo";
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" >
	...
	<head>
		...
		<link href="<?php echo $template_url.'/'; ?>new_style/css/main.css" rel="stylesheet" type="text/css" />
...
<link rel="stylesheet" type="text/css" href="<?php echo $template_url.'/'; ?>new_style/css/bootstrap-toggle.css">
<link rel="stylesheet" type="text/css" href="<?php echo $template_url.'/'; ?>new_style/css/bootstrap-toggle.css">
...
var img_width = $('#imag_val').width();
var img_height = $('#imag_val').height();	
...
var img_width = $('#imag_val1').width();
var img_height = $('#imag_val1').height();	
...
var img_width = $('#imag_val2').width();
var img_height = $('#imag_val2').height();	
...
var img_width = $('#imag_val3').width();
var img_height = $('#imag_val3').height();	
...
var img_width = $('#imag_val4').width();
var img_height = $('#imag_val4').height();	
...
var img_width = $('#imag_val5').width();
var img_height = $('#imag_val5').height();	
...
var img_height = $('#imag_val6').height();	
...
?>								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 hidden-xs  hidden-sm">
				...
				<i class="fa fa-heart" style="font-size: 140px;    color: #f00;"></i><span style="position: absolute;  left: 60px;  margin-top: 45px;  z-index: 24;  font-size: 14px;"><span class="result_data"></span> New <br>Message
				</span>	</div></div>
...
<script src="<?php echo $template_url.'/'; ?>new_style/js/jquery.js"></script>
<script src="<?php echo $template.'/'; ?>photovalidation/bootstrap/dist/js/bootstrap.min.js"></script>		
    <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/plugins/flipclock/flipclock.js"></script>
    <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/plugins/smoothscroll/smoothscroll.js"></script>
   <!-- --photo validation---->
...
<script src="<?php echo $template.'/'; ?>photovalidation/demo.js"></script>    
 <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
    <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
    <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/plugins/fancybox/jquery.fancybox.js"></script>
    <script src="<?php echo $template_url.'/'; ?>new_style/js/plugins/owl/owl.carousel.min.js" type="text/javascript"></script>
   <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/custom.js"></script>
   <script type="text/javascript" src="<?php echo $template_url.'/'; ?>new_style/js/bootstrap-toggle.js"></script>
<script>
    jQuery.noConflict();
(function($) {	
