...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr" >
	...
	<head>
		...
		<link href="<? echo $template_url.'/'; ?>new_style/css/main.css" rel="stylesheet" type="text/css" />
...
<link rel="stylesheet" type="text/css" href="<? echo $template_url.'/'; ?>new_style/css/bootstrap-toggle.css">
<link rel="stylesheet" type="text/css" href="<? echo $template_url.'/'; ?>new_style/css/bootstrap-toggle.css">
...
<script src="<? echo $template_url.'/'; ?>new_style/js/jquery.js"></script>
<script src="<? echo $template.'/'; ?>photovalidation/bootstrap/dist/js/bootstrap.min.js"></script>		
    <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/plugins/flipclock/flipclock.js"></script>
    <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/plugins/smoothscroll/smoothscroll.js"></script>
   <!-- --photo validation---->
...
<script src="<? echo $template.'/'; ?>photovalidation/demo.js"></script>    
 <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
    <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
    <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/plugins/fancybox/jquery.fancybox.js"></script>
    <script src="<? echo $template_url.'/'; ?>new_style/js/plugins/owl/owl.carousel.min.js" type="text/javascript"></script>
   <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/custom.js"></script>
   <script type="text/javascript" src="<? echo $template_url.'/'; ?>new_style/js/bootstrap-toggle.js"></script>
<script>
    jQuery.noConflict();
(function($) {	
