...
<link rel="stylesheet" type="text/css" href="<?php echo $template.'/'; ?>new_style/css/bootstrap-toggle.css">
<!--cropper-->
<link rel="stylesheet" href="<?php echo SITE_URL; ?>/app/app_profil/js/cropper.min.css">
  <link rel="stylesheet" href="<?php echo SITE_URL; ?>/app/app_profil/css/main.css">
  <!--cropper-->
...
<?php if($_GET["lang"]=="en"){ echo "New <br>Message"; }?>
			...
			<?php
						...
						if($user->id) {
							...
							<script type="text/javascript"
								src="<?php echo $template.'/'; ?>new_style/js/plugins/smoothscroll/smoothscroll.js"></script>
							<!-- --photo validation---->
							<script type="text/javascript"
								src="<?php echo $template.'/'; ?>new_style/js/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
							<script type="text/javascript"
								src="<?php echo $template.'/'; ?>new_style/js/plugins/revolution/js/jquery.themepunch.revolution.min.js"></script>
							<script type="text/javascript"
								src="<?php echo $template.'/'; ?>new_style/js/plugins/fancybox/jquery.fancybox.js"></script>
							...
							<?php if($app == 'profil') { ?>
							<script src="<?php echo SITE_URL; ?>/app/app_profil/js/jquery-1.12.4.min.js"></script>
							<script src="<?php echo SITE_URL; ?>/app/app_profil/js/bootstrap.min.js"></script>
							<script src="<?php echo SITE_URL; ?>/app/app_profil/js/cropper.min.js"></script>
							<script src="<?php echo SITE_URL; ?>/app/app_profil/js/main.js"></script>
							<?php } ?>
...
<noscript>
	<div style="display:inline;">
		<img height="1" width="1" style="border-style:none;" alt=""
			src="//www.googleadservices.com/pagead/conversion/965465621/?label=&amp;guid=ON&amp;script=0" />
	</div>
</noscript>
<?php 						}
...
<?php } ?>
<?php  if($action == 'step2')  { ?>
<script src="<?php echo SITE_URL; ?>/app/app_profil/js/reg_main.js"></script>
<?php } ?>
<?php if($action == 'step5') { ?>
<script src="<?php echo SITE_URL; ?>/app/app_profil/js/main_chiled.js"></script>
<?php } ?>
