...
file_put_contents('images/profil/'.$upload_dir.'/parent-solo-109-profil-'.$maxvalue.'.jpg', $data3, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/parent-solo-220-profil-'.$maxvalue.'.jpg', $data4, false, $context);
file_put_contents('images/profil/'.$upload_dir.'/parent-solo-profil-'.$maxvalue.'.jpg', $data5, false, $context);
echo "1";
}
