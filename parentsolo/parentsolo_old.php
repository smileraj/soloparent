...
(function($) {
	$(document).ready(function() 
 {
	...
	/* $.ajax({
					...
					type:'post',
					url:'ajaxchatMessge.php/junk/4',
					data:datastring,
					success:function(data_val){
					//var result_val = $.parseJSON(data_val);
   // $('#course_name').val(result_val.a);
  //$('#course_credit').val(result_val.b);
 
						console.log(data_val.a);
						console.log(data_val.b);
						/* if(sound_test!=data_val){
						<?php echo "<embed src='sound/notify.mp3' autostart='false' width='0' height='0' id='sound1' enablejavascript='true'>";?>
						} sound_test+=1;*/
						//sound_test = data_val;						
						//if(data_val <= '1'){
						//alert(data);
