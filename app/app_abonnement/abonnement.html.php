   ...
   <div class="price_cls">
      ...
      <div class="col-md-12  col-xs-12">
         <div class="col-md-3 col-sm-3  col-xs-3">
            <a href="javascript:abonnementFormSubmit(5);" class="methode m1" title="<?php echo $lang_appabonnement["PaiementEnLigne"];?>"><img src="<?php echo SITE_URL; ?>/images/methode1-<?php echo $_GET['lang']?>.png" alt="<?php echo $lang_appabonnement["PaiementEnLigne"];?>" /></a>
         </div>
		 <!-- <div class="col-md-3 col-sm-3  col-xs-3">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td class='fin' align="center"><img alt="" src="http://www.parentsolo.ch/images/non.gif" /></td>
								<td class='fin' align="center"><img alt="" src="http://www.parentsolo.ch/images/non.gif" /></td>
								<td class='fin' align="center"><img alt="" src="http://www.parentsolo.ch/images/oui.gif" /></td>
							</tr>
						<?php
							}*/
						?>
	...
	public static function razorPayReturn($duree_credite, $paymentDetails = null) {
		global $langue;
		include("lang/app_abonnement." . $_GET['lang'] . ".php");
		...
		if ($duree_credite) {
			...
			<div class="texte_explicatif">
				<?php echo $lang_appabonnement["TransactionValidee"]; ?>!<br /><br />
				<?php echo $lang_appabonnement["CompteCredite"]; ?> : <?php echo htmlspecialchars($duree_credite->duree . ' ' . $duree_credite->unite); ?><br /><br />
				<?php if ($paymentDetails && isset($paymentDetails->razorpay_payment_id)) { ?>
					<strong>Payment ID:</strong> <?php echo htmlspecialchars($paymentDetails->razorpay_payment_id); ?><br /><br />
				<?php } ?>
