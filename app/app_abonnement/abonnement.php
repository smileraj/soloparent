...
//
	...
	function abonnementRazarPayReturn() {
		...
		$razorpay_payment_link_id = $_GET['razorpay_payment_link_id'] ?? null;
		$razorpay_payment_link_status = $_GET['razorpay_payment_link_status'] ?? null;
		$razorpay_signature = $_GET['razorpay_signature'] ?? null;
		$custom_encoded = $_GET['custom'] ?? null;
		...
		// Decode custom data
		$arguments = explode(":", base64_decode((string) $custom_encoded));
		$md5 = $arguments[0];
