...
class table_HTML {
    ...
    public static function listevent(&$listdetails, &$search) {
        global $user, $lang_event,$lang;
        ...
        if ($nb_listdetails != 0) {
            ...
            <div class="parentsolo_txt_center mainhead">
                <h2 class="parentsolo_title barre">List of events</h2>
                <div class="wedd-seperator" style="padding-bottom:30px;">
                    <img src="images/bg_img/saprator.png" alt="">
                </div>
            </div>
            <?php if ($user->id) { ?>
                <div class="col-md-8 col-md-offset-2 parentsolo_form_style parentsolo_mb_40" id="hide_form">
                    <h3 class="parentsolo_title_h3 parentsolo_txt_center">Search</h3>
                    <div class="row bottompadding parentsolo_mt_10">
                        ...
                        <div class="col-md-4 parentsolo_txt_center">
                            <input type="button" name="searchclick" id="searchclick" style="padding:7px 25px;" 
                                   value="Search" class="bouton envoyer parentsolo_btn">
                        </div>
                    </div>
                </div>
            <?php } ?>
                ...
                <div class="col-md-12">
                    ...
                    for ($j = 0; $j < $nb_listdetails; $j++) {
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="col-md-12 col-sm-12 testimonials-style-2 parentsolo_pl-r">
                                <div class="col-md-3 col-sm-4 col-sx-4 parentsolo_pl_0 Parentsolo_imgbg_color">
                                    <div class="box">
                                        <div class="outer">
                                            <div class="round">
                                                <a href="<?php echo JL::url('index.php?app=event&action=read&id='.$listdetail->id.'&lang='.$lang); ?>">
                                                    <img width="100" height="100" src="<?php echo $photo; ?>" alt="<?php echo $listdetail->username; ?>">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-9 col-sm-8 col-sx-8">
                                    <div class="parentsolo_pt_15 parentsolo_pl_15 parentsolo_pb_15">
                                        ...
                                        <div class="text-box parentsolo_pt_10 parentsolo_pb_10"><?php echo $listdetail->event_desc; ?></div>
                                        <a class="username" href="<?php echo JL::url('index.php?app=event&action=read&id='.$listdetail->id.'&lang='.$lang); ?>">
            ...
            echo '<div align="middle" class="error">'.$lang_event["AucuneAppelATemoins"].'</div>';
        }
    }
public static function readlist(&$readlist){ 
        global $user;
        global $langue;
                ...
                <div class="contentl">
                    <div class="colc">
                        <div class="parentsolo_txt_center">
                            <h3 class="barre parentsolo_title"><?php echo $contenu->event_name;?></h3>
                            <div class="wedd-seperator parentsolo_pb_10">
                                <img src="images/bg_img/saprator.png" alt="">
                            </div>
                        </div>
                        <p>
                            <div class="temoignage">
                                <div class="row publication">
                                    <div class="col-md-4">
                                        <img id="event_img" name="event_img" style="border: 1px solid rgb(72, 71, 71);box-shadow: 5px 5px 0px rgba(0, 0, 0, 0.24);" src="images/events/<?php echo $contenu->filename ?>">
                                    </div>
                                    <?php if($user->id==$contenu->uservalue){ ?>
                                    <div class="col-md-8">
                                        <div style="text-align:right;">
                                            <div style="cursor:pointer" class="bouton envoyer a_link_icon edit fa fa-pencil-square-o" id="edit_<?php echo $contenu->id ?>"></div>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <div style="color:red;cursor:pointer;" class="bouton envoyer a_link_icon delete fa fa-trash-o" id="delete_<?php echo $contenu->id ?>"></div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="col-md-8">
...
public static function search(&$listdetails, &$search) {
    global $user, $lang_event;
                        ...
                        <div class="col-md-12 col-sm-12 testimonials-style-2 parentsolo_pl-r">
                            <div class="col-md-3 col-sm-4 col-sx-4 parentsolo_pl_0 Parentsolo_imgbg_color">
                                <div class="box">
                                    <div class="outer">
                                        <div class="round">
                                            <a href="<?php echo JL::url('index.php?app=event&action=read&id='.$listdetail->id.'&lang='.$_GET['lang']); ?>" title="<?php echo $lang_event["LireAppelATemoins"]; ?>">
                                                <img width="100" height="100" src="<?php echo $photo; ?>" alt="<?php echo $listdetail->username; ?>">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-9 col-sm-8 col-sx-8">
                                <div class="parentsolo_pt_15 parentsolo_pl_15 parentsolo_pb_15">
                                    <h2 class="name parentsolo_pt_10"><?php echo $event_name; ?></h2>
                                    <div class="text-box parentsolo_pt_10 parentsolo_pb_10"><?php echo $event_desc; ?></div>
                                    <a class="username" href="<?php echo JL::url('index.php?app=event&action=read&id='.$listdetail->id.'&lang='.$_GET['lang']); ?>">
                                        <h6 class="parentsolo_text-right parentsolo_txt_clr parentsolo_txt_overflow"><?php echo $listdetail->username; ?></h6>
                                    </a>
                                </div>
                            </div>
...
<div class="col-md-12">
				...
				<input type="file" required name="txt_evt_logo"   id="txt_evt_logo" class="validation updateval">
    ...
    font-family: Arial;
    text-align: left;
    white-space: nowrap;">Toutes les photos ont &eacute;t&eacute; r&eacute;ceptionn&eacute;es.</div>
