			...
			?>
				<div class="home">
					...
					<div class="actu">
						...
						<?php // affichage des 4 derni&egrave;res news
							if (is_array($rows)) {
								$i = 1;
								?>
								<ul>
					...
					<div class="blocs4">
						...
						<div class="bloc3">
							...
							<br />
							<br />
							Vous souhaitez faire part de votre exp&eacute;rience de <b>parent c&eacute;libataire</b> &agrave; la radio, la t&eacute;l&eacute; ou dans la presse ? Alors consultez notre rubrique &laquo; <a href="<?php echo JL::url('index.php?app=appel_a_temoins&action=list'); ?>" title="Appels &agrave; t&eacute;moins propos&eacute;s par des m&eacute;dias">Appels &agrave; t&eacute;moins</a> &raquo; pour d&eacute;couvrir les annonces des m&eacute;dias !
						</div>
						<div class="bloc-sep">&nbsp;</div>
						<div class="bloc4">
