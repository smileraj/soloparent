...
<div class="item">
               ...
               <div data-speed="0" data-type="html" class="rd-parallax-layer">
                  <div class="shell section-md-top-0 section-md-bottom-100 section-80 text-center text-l margin-top_res_div">
                   <!-- <a href="<?php  // echo SITE_URL; ?>/index.php?lang=<?php  //echo $_GET['lang']; ?>" title="<?php  //echo SITE_DESCRIPTION; ?>" class="logo" ><img src="<?php  // echo $template;?>/images/logo_<?php  // echo $_GET['lang']; ?>.jpg" alt="ParentSolo.ch"  /></a>-->
