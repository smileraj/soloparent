<?php
	...
	class home_HTML {		
		...
		public static function home($auth='', &$profils, &$list, &$temoignage, &$home_1, &$home_2, &$home_3, &$home_4, &$partenaire_1, &$actualites, &$box_menu_2,&$events) {
...
<div class="item">
               ...
               <div data-speed="0" data-type="html" class="rd-parallax-layer">
    			...
    			<div id="radios1">
    				...
    				<label for="option7" class="inscription_icon"><span <? if($_GET['lang']=="fr"){ ?>class="fr_label" style="margin-left: -65px !important;"  <? } ?> ><?php echo $lang_apphome["gendre_lan_f"];?><i class="fa fa-female"></i></span></label>
