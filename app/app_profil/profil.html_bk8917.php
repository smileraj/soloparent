...
if($_GET["lang"]=="de"){ 
						...
						if($_GET["lang"]=="fr"){  
						echo "Vous devez confirmer votre adresse email avant de pouvoir vous connecter.   Nous vous avons envoy� un lien d'activation �:  ".$user_email.".   Si vous ne trouvez pas notre message, pensez � v�rifier l'onglet SPAM de votre bo�te mail.";
						}
						if($_GET["lang"]=="en"){
