   ...
   $.ajax({
	...
	var datasplit=data.split('<br>');
		...
		loadVilles();	
				...
				<div class="col-md-12">
					<input type="checkbox"    name="offres"  oninvalid="this.setCustomValidity('<?php if($_GET['lang']=='fr'){ echo "Merci de cocher la case ci-contre.";	}elseif($_GET['lang']=='en'){ echo "Please tick the box";}elseif($_GET['lang']=='de'){ echo "Vink het vakje aan"; }?>')" oninput="setCustomValidity('')" style="width:20px;"  /> <b><?php echo $lang_appprofil["JeSouhaiteRecevoirOffresPartenaires"];?></b>
				</div>				
				</div>
				<div class="formwidth bottompadding">
