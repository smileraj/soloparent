			...
			<?php 			
						...
						<div class="col-md-4 col-xs-12 col-sm-3 parentsolo_pt_10">
							<div class="hovereffect parentsolo_border_radius  ">
								<?php 										if($list_type){
									?>
									<a href="<?php echo JL::url('index.php?app=profil&action=view&id='.$row->id.'&lang='.$_GET['lang']); ?>"  title="<?php echo $lang_flbl["VoirCeProfil"]; ?>">
									<img src="<?php echo $photo_liste; ?>" alt="<?php echo $row->username; ?>" class="profil"/></a>
									<?php 										}else{
									?>
						...
						<div class="infos"><?php echo $row->age; ?> <?php echo $lang_flbl["ans"];?> - <?php echo $row->nb_enfants; ?> <?php echo $row->nb_enfants > 1 ? $lang_flbl["enfants"] : $lang_flbl["enfant"]; ?> - <?php echo $row->canton_abrev; ?> <?php if($list_type){ ?><div class="connect"><span class="<?php echo $last_online_class; ?>"><?php echo $last_online_label; ?></span></div><?php } ?>
						
						</div>
						<div class="supplement">
									<b><?php echo $lang_flbl["AjouteLe"];?></b> - <?php echo date('d/m/Y', strtotime((string) $row->datetime_add)); ?> </div>
								<div class="connect">
								<a href="<?php echo JL::url('index.php?app=flbl&action=add&list_type='.$list_type.'&user_id_to='.$row->id.'&'.$langue); ?>" title="<?php echo $lang_flbl["ModifierLeCommentaire"];?>"><?php echo $lang_flbl["ModifierLeCommentaire"];?></a>
						</div>	
						</div>
						...
						<div class="col-md-12 parentsolo_pt_10">
								...
								<div class="actions">
									<?php 										if($list_type){
									?>
											<a href="<?php echo JL::url('index.php?app=profil&action=view&id='.$row->id.'&lang='.$_GET['lang']); ?>" target="_blank" title="<?php echo $lang_flbl["VoirCeProfil"]; ?>"><img src="<?php echo $photo_liste; ?>" alt="<?php echo $row->username; ?>" class="profil"/></a>
											<br />
											<a href="<?php echo JL::url('index.php?app=message&action=write&user_to='.$row->username.'&'.$langue); ?>" title="<?php echo $lang_flbl["EnvoyerUnMail"];?>"><img src="<?php echo SITE_URL; ?>/<?php echo SITE_TEMPLATE; ?>/images/btn_message.png" alt="<?php echo $lang_flbl["EnvoyerUnMail"];?>" /></a>
											<a href="<?php echo JL::url('index.php?app=message&action=flower&user_to='.$row->username.'&'.$langue); ?>" title="<?php echo $lang_flbl["EnvoyerUneRose"];?>" ><img src="<?php echo SITE_URL; ?>/<?php echo SITE_TEMPLATE; ?>/images/btn_rose.png" alt="<?php echo $lang_flbl["EnvoyerUneRose"];?>" /></a>
											<a href="javascript:windowOpen('ParentSoloChat','<?php echo JL::url('index.php?app=chat&id='.$row->id.'&'.$langue); ?>','800px','600px');" title="<?php echo $lang_flbl["Chat"];?>"><img src="<?php echo SITE_URL; ?>/<?php echo SITE_TEMPLATE; ?>/images/btn_chat.png" alt="<?php echo $lang_flbl["Chat"];?>" /></a>
								...
								<div class="username">
									<?php 										if($list_type){
									?>
											<a href="<?php echo JL::url('index.php?app=profil&action=view&id='.$row->id.'&lang='.$_GET['lang']); ?>" target="_blank" title="<?php echo $lang_flbl["VoirCeProfil"];?>" class="username"><?php echo $row->username; ?></a>
									<?php 										}else{
