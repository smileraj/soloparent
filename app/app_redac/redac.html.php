<?php
	...
	class redac_HTML {
		...
		// affiche un $contenu
		public static function contenuAfficher(&$contenu) {
			global $langue;
			...
			?>
				<div class="app_body">
					<div class="contenu">
						<h1><?php echo $contenu->titre; ?><?php if($contenu->type_id == 1) { ?><br /><span><?php echo $lang_redac["ActualiteDu"];?> <?php echo date('d/m/Y', strtotime((string) $contenu->date_add)); ?><?php } ?></h1>
