<?php
		...
		<div class="row">
				<div class="col-md-12">
					<?
						...
						<a href="<? echo $lien; ?>" title="<? echo $title; ?>"><img src="<? echo SITE_URL.'/'.$image; ?>" alt="<? echo $row->titre; ?>" class="superpose " id="img_1" style="width:100%;"/></a>
													 <?
														if(time()-strtotime($row->date_add) < 3600*24*3) { 
													?>
															<a href="<? echo $lien; ?>" title="<? echo $title; ?>"><img src="<? echo SITE_URL.'/images/groupe/groupe-calque-'.$_GET['lang'].'.png'; ?>" alt="<? echo $row->titre; ?>"  style="width:100%;" class="superpose" id="img_2" /></a>
													<? 
														} 
													?>
													</div>
	...
	<div class="col-md-12 parentsolo_plr_0">
		...
		public static function groupeFiche(&$row, &$membres, &$search) {
			...
			<div class="circular-item" title="">
									...
									<div style="width:60px;display:inline;&quot;">
										<canvas width="60" height="60"></canvas><?// pas le groupe par d&eacute;faut
						if($row->id != 1) {
						?>
						...
						<?// pas le groupe par d&eacute;faut
						if($row->id != 1) {
						?>
		...
		?>
			<? // si le groupe a d&eacute;j&agrave; &eacute;t&eacute; enregistr&eacute;
				if($row->id) {
							...
							<div class="col-md-12 parentsolo_txt_center">
								...
								<?
									...
									<div class="miniature" id="val_id">
										<img src="<? echo SITE_URL.'/'.$image; ?>?<? echo time(); ?>" id="get_img" />
