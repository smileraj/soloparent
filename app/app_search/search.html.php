			...
			<?
				...
				<div class="col-md-12">
						...
						<div class="supplement">
								...
								<!--<div class="connect"><span class="<? echo $last_online_class; ?>"><? echo $last_online_label; ?></span></div>-->
						</div>
...
if(strtotime($time_creation) > strtotime($newdate)){   $connexion_date	= date('d/m/Y', strtotime($result->creation_date));  }
						...
						<div class="supplement">
									<b><?php echo $lang_search["DateInscription"];?>:</b> <? echo $connexion_date;/* date('d/m/Y', strtotime($result->creation_date)); */ ?>
								</div>
						<!--<div class="connect">
								<span class="<? echo $last_online_class; ?>"><? echo $last_online_label; ?></span>
						</div>-->
